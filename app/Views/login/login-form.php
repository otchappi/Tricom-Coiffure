...
<html
  ...
  <head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="<?= vendor_url('css/pages/page-auth.css');?>" />
    <!-- Helpers -->
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="<?=base_url()?>" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">Universal - Tel</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Bienvenue 👋</h4>
              <p class="mb-4">Merci de vous identifier</p>

              <?php
                if(!empty($validation))  {?>
                    <div class="alert alert-danger alert-dismissible">
                        <button type="button" class="close" data-dismiss="alert">&times;</button>
                        <strong class="small"><?= $validation->showError('password', 'single') ?></strong>
                    </div>
              ...
              <form id="formAuthentication" class="mb-3" action="<?= base_url('Index/authentification'); ?>" method="POST">
                <div class="mb-3">
                ...
                <div class="mb-3 form-password-toggle">
                  <div class="d-flex justify-content-between">
                    ...
                    <a href="<?= base_url('Index/motDePasseOublie'); ?>">
                ...
                <div style="text-align: center;">
					Copyright &copy; 2023 &mdash; Universal - Tel 
				</div>
              </form>
            </div>
          </div>
